...
| 413             | -32099         | `payload too large`                                            | The request body exceeds the size limit for the method being called.  | Stay within the body-size limit for the method class. See [Request Body Limits](./README.md#request-body-limits).     |
...
| 429             | -32005         | `Rate limit exceeded`                                          | The request exceeds the rate limit for its method category.           | Reduce request frequency, or use batching or WebSocket subscriptions. See [Rate Limiting](./README.md#rate-limiting). |
...
- [RPC Reference](./README.md) — full method availability table
