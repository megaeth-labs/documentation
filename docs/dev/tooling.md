...
| node101        | HTTP               | [Plans and access](https://node101.io/en/rpc/megaeth)                          | No public endpoint (paid plan required)                   | Supported |
| node101        | WebSocket          | [Plans and access](https://node101.io/en/rpc/megaeth)                          | No public endpoint (paid plan required)                   | Supported |
...
| [SQD](https://www.sqd.ai)         | [Docs](https://docs.sqd.dev/en/data/evm/megaeth-mainnet)                         | [Subsquid data lake / Portal API](https://docs.sqd.dev/en/data/evm/megaeth-mainnet), [Squid SDK](https://github.com/subsquid-labs/squid-megaeth-example)                                                                     | Supported |
